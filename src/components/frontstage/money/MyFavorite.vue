...
const props = defineProps(['ratingComicId', 'userId', 'comicId', 'like', 'ratingDate']);
...
onMounted(() => {
  getComicById(props.comicId);
})

/**
 * 取得comicTitle, comicCover
 * @param comicId
 * @returns {Promise<void>}
 */
async function getComicById(comicId) {
  const url = `/comicD/simplecomic?comicId=${comicId}`;

        ...
        <div class="containerUser">
            <div class="info" v-if="userDBData.value">
                    ...
                    <div v-if="!isEditing">
                        <div style="display: flex">
                            <div class="userinput">
                                ...
                                <p>
                                    Birthday : {{ userDBData.value.birthDate }}
                                </p>
                                <p>
                                    Register Date :
                                    {{ userDBData.value.registerDate }}
                                </p>
                            </div>
                        ...
                        <div style="display: flex">
                            <div class="userinput">
                                ...
                                <p>
                                    ...
                                    <input
                                        type="text"
                                        v-model="userDBData.value.email"
                                    />
                                </p>
                                <p>
                                    Gender :
                                ...
                                <p>
                                    ...
                                    <input
                                        type="date"
                                        v-model="userDBData.value.birthDate"
                                    />
                                </p>
                                <p>
                                    Register Date :
                            ...
                            <div class="userPhotoUpl">
                                <div>
                                    <img
                                        :src="userDBData.value.userPhoto"
                                        class="img-thumbnail"
                                        alt=""
                ...
                >
                    <p>Badges :</p>
                    <div
                        v-for="data in userBadgeDBData"
                        :key="data"
                        class="badge"
                    >
                        <div class="badge-circle">
                            <img
                                :src="data.badge.badgePhoto"
                                :alt="data.badge.badgeName"
                                :title="data.badge.badgeDetail"
                            />
                        </div>
    ...
    try {
        const firebaseConfig = {
            ...
            messagingSenderId: import.meta.env
                .VITE_FIREBASE_USERA_MESSAGING_SENDER_ID,
...
const submitEditedInfo = async () => {
    try {
        const formattedBirthDate = convertDateFormat(
            userDBData.value.birthDate
        );

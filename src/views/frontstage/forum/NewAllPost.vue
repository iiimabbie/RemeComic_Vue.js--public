<template>
    <div v-show="!showCommentPage">
        <h2 style="text-align: center;padding-top: 1rem;">New Post</h2>
        <NewPostNav :nowView="'All'" />
    </div>
    <PostWall :targetPostsUrl="'/post/show/new'" :hadeAddPostSection="true" @isShowComment="getIsShowComment"
        @backFromComment="getBackFromComment" />
</template>
<script setup>
import { onActivated, onDeactivated, ref } from 'vue';
import PostWall from "@/components/frontstage/forum/PostWall.vue"
import NewPostNav from '@/components/frontstage/forum/NewPostNav.vue';

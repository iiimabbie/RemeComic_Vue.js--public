...
const rechargeUrl = ref(
    `http://localhost:8080/remecomic/money/recharge?userId=${userId.value}&rechargeAmount=${rechargeAmount.value}`
);
...
<!--  <canvas></canvas>-->
  ...
  <div class="login-box">
    ...
    <form>
      <div class="user-box">
        <input type="text" v-model.trim="rechargeAmount" name="" required="">
        <label>RechargeAmount</label>
      </div>
      <center>
        <a @click="handleSubmitButtonClick">
          Checkout
          <span></span>
        </a></center>
    </form>

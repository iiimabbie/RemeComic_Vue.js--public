...
import PersonalOrders from "@/components/frontstage/money/PersonalOrders.vue";
...
async function getOrdersByUserId() {
  const url = "/money/orders/findUserByPage";
...
watch(currentPageNum, getOrdersByUserId);
...
<template>
  <FrontstageHeader class="frontpageContainer"/>
